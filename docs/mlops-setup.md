...
git add README.md docs .gitignore shaotong_stacks/resources/README.md
...
If you want to use different catalog names, please update the targets declared in the [shaotong_stacks/databricks.yml](../shaotong_stacks/databricks.yml)
and [shaotong_stacks/resources/ml-artifacts-resource.yml](../shaotong_stacks/resources/ml-artifacts-resource.yml)  files. 
...
Follow the instructions in [shaotong_stacks/resources/README.md](../shaotong_stacks/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../shaotong_stacks/resources/README.md)  to propose, test, and deploy
