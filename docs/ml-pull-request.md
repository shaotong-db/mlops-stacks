...
Opening a pull request will trigger a[workflow](../.github/workflows/shaotong_stacks-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-dogfood.staging.cloud.databricks.com/ml/models/staging-shaotong_stacks-model)
* [Prod workspace registered model](https://your-prod-workspace.cloud.databricks.com/ml/models/prod-shaotong_stacks-model). 
